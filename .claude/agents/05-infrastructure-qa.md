...
**Alias**: `@infra`
**Priority**: High (manages deployment, monitoring, testing, and operations)
...
When activated, the Infrastructure & QA Agent MUST follow this sequence:
...
model_latency = Histogram("model_prediction_latency_seconds", "Latency")
```
