...
const navItems: NavItem[] = [
  ...
  { icon: Crosshair, label: "Stress Map", href: "/stress-map", permission: "risk.advanced.read" },
  { icon: Bot, label: "Models", href: "/models", permission: "models.governance.read" },
  { icon: Microscope, label: "Trade Forensics", href: "/forensics", permission: "read.basic" },
  { icon: GitBranch, label: "Strategy Composer", href: "/composer", permission: "control.jobs.create" },
