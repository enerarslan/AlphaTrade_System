...
class Portfolio(BaseModel):
    ...
    timestamp: datetime = Field(default_factory=datetime.utcnow, description="Portfolio snapshot time")
...
class RiskMetrics(BaseModel):
    ...
    timestamp: datetime = Field(default_factory=datetime.utcnow, description="Metrics calculation time")
...
class ModelPrediction(BaseModel):
    ...
    symbol: str = Field(..., description="Ticker symbol")
    timestamp: datetime = Field(default_factory=datetime.utcnow, description="Prediction time")
